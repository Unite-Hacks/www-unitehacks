...
const DateTime = () => {
  return (
    <div className="grid md:grid-layout">
      <div className="w-c md:w-[100%] dates mx-auto text-white flex justify-between mt-5">
      ...
      <div className="w-c md:w-[100%] time mx-auto flex justify-center rounded-md bg-white mt-5">
        <div className="w-c md:w-[100%] border-2 border-white">
      ...
      <div className="w-c md:w-[100%] venue mx-auto flex justify-center rounded-md border-[5px] border-white mt-5">
        <div className="w-c md:w-[100%]">
      ...
      <div className="w-c md:w-[100%] guidelines mx-auto flex justify-center rounded-md bg-white mt-5">
        <div className="w-c md:w-[100%] border-2 border-white">
          <h2 className="text-sh-xl font-extrabold italic g-heading">
            covid-19
          </h2>
      ...
      <div className="w-c md:w-[100%] eligibility mx-auto flex justify-center rounded-md border-[5px] border-white mt-5">
        <div className="w-c md:w-[100%]">
          <h2 className="text-sh-xl font-extrabold italic text-white">
            eligibility
          </h2>
